...
const birth = () => {
  ...
  myTama.name = prompt("Quel nom a votre tamagoshi ?");
  // 2) fait éclore mon oeuf pour passer au poussin
  showInScreen("🐣");
  // 3) affiche mes vitals
...
1) Attendre que notre tamagoshi ait une a"première envie"
2) Il devient grand
*/
const evolve = () => {
  // 1) Attendre que notre tamagoshi ait une "première envie"
